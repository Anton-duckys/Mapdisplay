...
void PopUp::show(QPointF showPoint)
{
    ...
    /*setGeometry(QApplication::desktop()->availableGeometry().width() - 100 - width() + QApplication::desktop() -> availableGeometry().x(),
                QApplication::desktop()->availableGeometry().height() - 100 - height() + QApplication::desktop() -> availableGeometry().y(),
                100,
               100);*/
    //setFixedHeight(100);
